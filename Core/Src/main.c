...
//	display_symbols_sequentially("1c2", 1000);
...
//		CAN_TxData(0x0378);
		TIM4_Set_symbol(2000, "c10");
		 TIM4_Set_symbol(8000, ">10");
		 TIM4_Set_symbol(2000, "c11");
//		  TIM4_Set_symbol(5000, '1', 10);
//		  set_symbol('c', 8);
//		  TIM4_Set_symbol(5000, '>', 1);
//		set_symbol('1', 1);
    /* USER CODE END WHILE */
