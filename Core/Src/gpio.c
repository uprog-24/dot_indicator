...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, ROW_2_Pin|COL_L1_Pin|COL_L2_Pin|COL_L3_Pin
                          |COL_L4_Pin|COL_L5_Pin|COL_R7_Pin|COL_R8_Pin
                          |ROW_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, COL_L6_Pin|COL_L7_Pin|COL_L8_Pin|COL_R1_Pin
                          |COL_R2_Pin|COL_R3_Pin|COL_R4_Pin|COL_R5_Pin
                          |COL_R6_Pin|GPIO_PIN_3|ROW_3_Pin|ROW_4_Pin
                          |ROW_5_Pin|ROW_6_Pin|ROW_7_Pin|ROW_8_Pin, GPIO_PIN_RESET);
